...
parser.add_argument('--dataset_cls', type=str, default='Vaihingen', help='cityscapes')
parser.add_argument('--trunk', type=str, default='resnet50', help='cnn trunk')
parser.add_argument('--dataset_dir', type=str, default=None,
                    help='Dataset Location')
parser.add_argument('--split', type=str, default='test')
parser.add_argument('--crop_size', type=int, default=513)
parser.add_argument('--exp_name', type=str, default=None)
parser.add_argument('--snapshot', type=str, default='/home/caoyiwen/slns/PFNets/logs/ckpt/default/Vaih-network.pointflow_resnet_with_max_avg_pool.DeepR50_PF_maxavg_deeply_apex_F/best_epoch_98_mean-iu_0.67723.pth')
...
parser.add_argument('--resize_scale', type=int, default=768)
