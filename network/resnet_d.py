...
def resnet50(pretrained=True, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(torch.load("/home/caoyiwen/pretrained weights/resnet50-deep.pth", map_location='cpu'))
        print('##########################已加载50预训练模型########5050505050505050################')
    return model
...
def resnet101(pretrained=True, **kwargs):
    ...
    print('##########################已加载预训练模型##################################')
    if pretrained:
        model.load_state_dict(torch.load("/home/caoyiwen/pretrained weights/resnet101-deep.pth",map_location='cpu'))
        print('##########################已加载预训练模型###########100100100100100100#######################')
    return model
